...
const file_ateapi_proto_rawDesc = "" +
	...
	"\x14current_snapshot_tag\x18\t \x01(\v2\x11.ateapi.ObjectRefR\x12currentSnapshotTag\"\xf2\x01\n" +
	...
	"!ACTOR_CERTIFICATE_PURPOSE_ATUNNEL\x10\x012\xbf\x12\n" +
	"\aControl\x124\n" +
...
var file_ateapi_proto_goTypes = []any{
	...
	(*ListWorkersRequest)(nil),             // 82: ateapi.ListWorkersRequest
	(*ListWorkersResponse)(nil),            // 83: ateapi.ListWorkersResponse
	(*GetWorkerRequest)(nil),               // 84: ateapi.GetWorkerRequest
	(*CreateWorkerRequest)(nil),            // 85: ateapi.CreateWorkerRequest
	(*UpdateWorkerRequest)(nil),            // 86: ateapi.UpdateWorkerRequest
	(*DeleteWorkerRequest)(nil),            // 87: ateapi.DeleteWorkerRequest
	(*DrainWorkerRequest)(nil),             // 88: ateapi.DrainWorkerRequest
	(*ListActorsRequest)(nil),              // 89: ateapi.ListActorsRequest
	(*ListActorsResponse)(nil),             // 90: ateapi.ListActorsResponse
	(*Worker)(nil),                         // 91: ateapi.Worker
	(*WorkerStatus)(nil),                   // 92: ateapi.WorkerStatus
	(*WorkerCapacity)(nil),                 // 93: ateapi.WorkerCapacity
...
var file_ateapi_proto_depIdxs = []int32{
	...
	99,  // 2: ateapi.Selector.match_labels:type_name -> ateapi.Selector.MatchLabelsEntry
	102, // 3: ateapi.ResourceMetadata.create_time:type_name -> google.protobuf.Timestamp
	102, // 4: ateapi.ResourceMetadata.update_time:type_name -> google.protobuf.Timestamp
	8,   // 5: ateapi.ExternalVolume.status:type_name -> ateapi.ExternalVolume.Status
	100, // 6: ateapi.ExternalVolume.volume_context:type_name -> ateapi.ExternalVolume.VolumeContextEntry
	...
	103, // 16: ateapi.EgressRule.all:type_name -> google.protobuf.Empty
	...
	102, // 41: ateapi.GoldenSnapshotStatus.take_golden_snapshot_at:type_name -> google.protobuf.Timestamp
	...
	91,  // 94: ateapi.ListWorkersResponse.workers:type_name -> ateapi.Worker
	26,  // 95: ateapi.GetWorkerRequest.worker:type_name -> ateapi.ObjectRef
	91,  // 96: ateapi.CreateWorkerRequest.worker:type_name -> ateapi.Worker
	91,  // 97: ateapi.UpdateWorkerRequest.worker:type_name -> ateapi.Worker
	26,  // 98: ateapi.DeleteWorkerRequest.worker:type_name -> ateapi.ObjectRef
	81,  // 99: ateapi.DeleteWorkerRequest.options:type_name -> ateapi.DeleteOptions
	26,  // 100: ateapi.DrainWorkerRequest.worker:type_name -> ateapi.ObjectRef
	14,  // 101: ateapi.ListActorsResponse.actors:type_name -> ateapi.Actor
	12,  // 102: ateapi.Worker.metadata:type_name -> ateapi.ResourceMetadata
	101, // 103: ateapi.Worker.labels:type_name -> ateapi.Worker.LabelsEntry
	93,  // 104: ateapi.Worker.capacity:type_name -> ateapi.WorkerCapacity
	92,  // 105: ateapi.Worker.status:type_name -> ateapi.WorkerStatus
	6,   // 106: ateapi.WorkerStatus.state:type_name -> ateapi.WorkerState
	94,  // 107: ateapi.WorkerStatus.assignment:type_name -> ateapi.ActorAssignment
	...
	78,  // 123: ateapi.Control.CreateActorSnapshotTag:input_type -> ateapi.CreateActorSnapshotTagRequest
	75,  // 124: ateapi.Control.GetActorSnapshotTag:input_type -> ateapi.GetActorSnapshotTagRequest
	76,  // 125: ateapi.Control.ListActorSnapshotTags:input_type -> ateapi.ListActorSnapshotTagsRequest
	79,  // 126: ateapi.Control.UpdateActorSnapshotTag:input_type -> ateapi.UpdateActorSnapshotTagRequest
	80,  // 127: ateapi.Control.DeleteActorSnapshotTag:input_type -> ateapi.DeleteActorSnapshotTagRequest
	82,  // 128: ateapi.Control.ListWorkers:input_type -> ateapi.ListWorkersRequest
	84,  // 129: ateapi.Control.GetWorker:input_type -> ateapi.GetWorkerRequest
	85,  // 130: ateapi.Control.CreateWorker:input_type -> ateapi.CreateWorkerRequest
	86,  // 131: ateapi.Control.UpdateWorker:input_type -> ateapi.UpdateWorkerRequest
	87,  // 132: ateapi.Control.DeleteWorker:input_type -> ateapi.DeleteWorkerRequest
	88,  // 133: ateapi.Control.DrainWorker:input_type -> ateapi.DrainWorkerRequest
	89,  // 134: ateapi.Control.ListActors:input_type -> ateapi.ListActorsRequest
	51,  // 135: ateapi.Control.CreateAtespace:input_type -> ateapi.CreateAtespaceRequest
	52,  // 136: ateapi.Control.GetAtespace:input_type -> ateapi.GetAtespaceRequest
	53,  // 137: ateapi.Control.ListAtespaces:input_type -> ateapi.ListAtespacesRequest
	55,  // 138: ateapi.Control.DeleteAtespace:input_type -> ateapi.DeleteAtespaceRequest
	56,  // 139: ateapi.Control.CreateActorTemplate:input_type -> ateapi.CreateActorTemplateRequest
	57,  // 140: ateapi.Control.GetActorTemplate:input_type -> ateapi.GetActorTemplateRequest
	58,  // 141: ateapi.Control.ListActorTemplates:input_type -> ateapi.ListActorTemplatesRequest
	60,  // 142: ateapi.Control.DeleteActorTemplate:input_type -> ateapi.DeleteActorTemplateRequest
	95,  // 143: ateapi.ActorIdentity.MintJWT:input_type -> ateapi.MintJWTRequest
	97,  // 144: ateapi.ActorIdentity.MintCert:input_type -> ateapi.MintCertRequest
	...
	24,  // 156: ateapi.Control.CreateActorSnapshotTag:output_type -> ateapi.ActorSnapshotTag
	24,  // 157: ateapi.Control.GetActorSnapshotTag:output_type -> ateapi.ActorSnapshotTag
	77,  // 158: ateapi.Control.ListActorSnapshotTags:output_type -> ateapi.ListActorSnapshotTagsResponse
	24,  // 159: ateapi.Control.UpdateActorSnapshotTag:output_type -> ateapi.ActorSnapshotTag
	24,  // 160: ateapi.Control.DeleteActorSnapshotTag:output_type -> ateapi.ActorSnapshotTag
	83,  // 161: ateapi.Control.ListWorkers:output_type -> ateapi.ListWorkersResponse
	91,  // 162: ateapi.Control.GetWorker:output_type -> ateapi.Worker
	91,  // 163: ateapi.Control.CreateWorker:output_type -> ateapi.Worker
	91,  // 164: ateapi.Control.UpdateWorker:output_type -> ateapi.Worker
	91,  // 165: ateapi.Control.DeleteWorker:output_type -> ateapi.Worker
	91,  // 166: ateapi.Control.DrainWorker:output_type -> ateapi.Worker
	90,  // 167: ateapi.Control.ListActors:output_type -> ateapi.ListActorsResponse
	25,  // 168: ateapi.Control.CreateAtespace:output_type -> ateapi.Atespace
	25,  // 169: ateapi.Control.GetAtespace:output_type -> ateapi.Atespace
	54,  // 170: ateapi.Control.ListAtespaces:output_type -> ateapi.ListAtespacesResponse
	25,  // 171: ateapi.Control.DeleteAtespace:output_type -> ateapi.Atespace
	27,  // 172: ateapi.Control.CreateActorTemplate:output_type -> ateapi.ActorTemplate
	27,  // 173: ateapi.Control.GetActorTemplate:output_type -> ateapi.ActorTemplate
	59,  // 174: ateapi.Control.ListActorTemplates:output_type -> ateapi.ListActorTemplatesResponse
	27,  // 175: ateapi.Control.DeleteActorTemplate:output_type -> ateapi.ActorTemplate
